    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.CharField(choices=[('institution_user', 'Institution User'), ('regular_user', 'Regular User')], default='regular_user', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('institution', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='favorites', to='institutions.institution')),
